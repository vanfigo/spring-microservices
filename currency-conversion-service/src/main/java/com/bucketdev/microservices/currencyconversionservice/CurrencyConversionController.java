...
public class CurrencyConversionController {
    ...
    public CurrencyConversionBean converterCurrency(@PathVariable String from, @PathVariable String to,
    ...
    public CurrencyConversionBean converterCurrencyFeign(@PathVariable String from, @PathVariable String to,
                                                         @PathVariable BigDecimal quantity) {
        CurrencyConversionBean response = proxy.retrieveExchangeValue(from, to);
        CurrencyConversionBean currencyConversionBean =
                new CurrencyConversionBean(response.getId(), from, to, response.getConversionMultiple(), quantity);
        currencyConversionBean.setTotalCalculatedAmount(quantity.multiply(response.getConversionMultiple()));
        currencyConversionBean.setPort(response.getPort());
